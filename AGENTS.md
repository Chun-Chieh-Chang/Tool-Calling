...
npm run tracked-repos     # 重建追蹤池 (2118 repos)
...
├── registry/           # 工具庫與快照
│   ├── tools.json      # 513+ 工具 (單一真理來源)
│   ├── tracked-repos.json  # 2118 追蹤 repos
