...
npm run tracked-repos     # 重建追蹤池 (2530 repos)
...
fix(README): update tool count from 381 to 722 and add new features
...
├── registry/           # 工具庫與快照
│   ├── tools.json      # 722+ 工具 (單一真理來源)
│   ├── tracked-repos.json  # 2530 追蹤 repos
