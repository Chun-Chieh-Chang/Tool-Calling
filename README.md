...
想像你有一个 **全功能 AI 工具箱**，里面收录了 **591 个顶尖开源 AI 工具与 Agent 技能**：
...
1. 🌌 **Obsidian 風格 2D / 3D 雙視角動態知識圖譜 (Interactive Knowledge Graph)**：
   - 整合 591 個 AI 工具與技能的深層拓撲星系，支援 2D Vis.js 平面與 3D Three.js 宇宙視角無縫切換。
...
> Tool-Calling v1.4 - 591 Tools, 351 Synonyms, Live Refresh & Dual-Week Trending
---
