...
| 分類 | 數量 | 說明 |
|------|------|------|
| AI 框架 | 139 | LLM/Transformer/Generative AI 框架與 SDK |
| AI 代理 | 88 | Agent/Assistant/Copilot 系統 |
| 開發工具 | 46 | CLI、IDE、編程語言相關工具 |
| 學習資源 | 30 | 教程、課程、Roadmap、Awesome Lists |
| UI/UX設計 | 26 | 前端框架、設計系統、Figma 插件 |
| 文件生產力 | 22 | PPT、PDF、Markdown、Office 工具 |
| 影片 | 14 | 視頻編輯、動畫、直播工具 |
