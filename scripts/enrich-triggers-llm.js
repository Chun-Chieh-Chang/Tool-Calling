...
const GENERIC_PHRASES = [
  '幫我搞定', '帮我搞定', '幫我看看', '帮我看看', '幫我想想', '帮我想想', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '幫我想辦法', '帮我想办法', '求介紹', '求介绍', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '太麻煩', '太麻烦', '太耗時', '太耗时', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '有什麼推薦', '有什么推荐', '推薦個', '推荐个', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '有沒有工具', '有没有工具', '有什麼工具', '有什么工具', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '有工具嗎', '有工具吗', '有沒有APP', '有没有APP', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '這個怎麼搞', '这个怎么搞', '怎麼實現', '怎么实现', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '有沒有替代', '有没有替代', '有沒有類似', '有没有类似', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  '有沒有方法', '有没有方法', '有捷徑', '有捷径', // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
];
  ...
  for (let attempt = 0; attempt <= MAX_RETRIES; attempt++) {
    ...
    try {
      ...
      return text
        ...
        // 簡轉繁：LLM 訓練語料以簡體為主，常輸出「浏览器」「测试」，（allow-simplified：刻意引用的歷史範例）
