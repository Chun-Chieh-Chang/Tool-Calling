...
if (rate429 === 0 && otherFail === 0) {
  ...
  console.log(`\n    📌 2026-09-20 已在本專案端點實測過兩次（同一端點的兩把金鑰）：`);
  console.log(`         併發 4：1 把 → 23/40 成功、17 次 429`);
  console.log(`                 2 把 → 23/40 成功、17 次 429（各 8、9 次）`);
  console.log(`         併發 6：1 把 → 24/40 成功、16 次 429`);
  console.log(`                 2 把 → 25/40 成功、15 次 429（各 8、7 次）`);
  console.log(`         **成功數完全相同**（差 1 筆屬雜訊）`);
  console.log(`         → 額度是帳號／IP 共享，**加金鑰無效**，別花錢。`);
} else {
