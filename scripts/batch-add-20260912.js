...
const newEntries = [
  {
    ...
    category: '學習資源',
    language: 'go',
    triggers: ['weread-hot-booklists', '微信读书', '热门书单', '读书笔记', 'weread', 'booklist', 'reading-notes', '書單', '閱讀筆記', '热门收藏'], // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  ...
  },
  {
    ...
    category: 'API 整合',
    language: 'markdown',
    triggers: ['free-api', '免费api', '免费接口', '中文api', 'api大全', 'api-directory', '免費接口', '接口服务', '免费接口服务'], // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
  ...
  },
  {
    ...
    category: '學習資源',
    language: 'markdown',
    triggers: ['free-books', '免费书籍', '免费电子书', '互联网免费书籍', 'ebooks', 'free-ebooks', '免費書', '書單', '免費閱讀'], // allow-simplified：刻意引用的簡體關鍵字／範例，轉繁會破壞比對
